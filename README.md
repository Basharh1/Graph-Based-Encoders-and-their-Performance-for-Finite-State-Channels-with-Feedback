...
1. [Create_Channel.m](https://github.com/Basharh1/Bounds_on_Finite_State_Channels/blob/master/Code/Create_Channel.m), where you add the channel transition <img src="http://www.sciweavers.org/tex2img.php?eq=P_%7BY%7CX%2CS%7D&bc=White&fc=Black&im=jpg&fs=12&ff=fourier&edit=0" align="center" border="0" alt="P_{Y|X,S}" width="46" height="18" />.
2. [Create_S.m](https://github.com/Basharh1/Bounds_on_Finite_State_Channels/blob/master/Code/Create_S.m), where you add the state evolution <img src="http://www.sciweavers.org/tex2img.php?eq=P_%7BS%5E%2B%7CX%2CY%2CS%7D&bc=White&fc=Black&im=jpg&fs=12&ff=fourier&edit=0" align="center" border="0" alt="P_{S^+|X,Y,S}" width="62" height="18" />.  
